  ...
  render() {
    return (
      <div>
        ...
        <p className='bodyText'>
          <b>Robin Hochberg Louie</b> is a <i>summa cum laude</i> graduate of Barnard College, Columbia University with a B.A. in
          chemistry. She spent over two decades on Wall Street serving in a variety of roles including
          head of Municipal Bond Research at Goldman Sachs. In addition to structuring financings for
          issuers, crafting investment strategies for clients, and creating proprietary trading analyses for
          internal capital use, Robin was responsible for teaching employees, at all levels of management,
          the mathematics of fixed income securities. She has written several articles on various topics
          related to municipal bonds. While raising two boys of her own, she tutored geometry and algebra
          in a New York City public high school and has been coaching privately in chemistry, algebra and
          geometry for the past three years.
        </p>
      </div>
    )
  }
